...
export function detectRedundancy(context) {
  const opportunities = [];
...
function buildRedundancyOpportunity(opportunities, prompt, locations, context) {
...
//# sourceMappingURL=redundancy-detector.js.map
