...
export function suggestModelDowngrades(context) {
  const opportunities = [];
...
function evaluateDowngrade(call, context) {
...
function estimatePromptTokensForCall(sourceFile, line) {
...
function calculateSavings(currentModel, targetModel, context) {
...
//# sourceMappingURL=model-suggester.js.map
