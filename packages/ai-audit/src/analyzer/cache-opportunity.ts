...
export function detectCacheOpportunities(context: AnalyzerContext): OptimizationOpportunity[] {
...
function isIterationMethodCall(node: import('ts-morph').Node): boolean {
